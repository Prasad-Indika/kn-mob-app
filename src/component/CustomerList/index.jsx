...
export default function CustomerList({setCustomer}) {
    ...
    const customerData = useSelector((state)=>state.customerSlice.customer)
    ...
    const searchCustomer = (search)=>{
        const filteredArr = customerData?.data.filter(obj =>
  ...
  return (
    <>
        ...
        <View style={{flex:1 , backgroundColor:"#d5f0f5"}}>
            ...
            <View style={{flex:7 , backgroundColor: "#ffffff", borderRadius:12, margin:8,paddingBottom:5}}>
